...
public class RegistrarAluno extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RegistrarAluno frame = new RegistrarAluno();
	...
	public RegistrarAluno() {
		...
		lblRegistrarAluno.setForeground(new Color(128, 0, 0));
		lblRegistrarAluno.setHorizontalAlignment(SwingConstants.CENTER);
		lblRegistrarAluno.setFont(new Font("Montserrat ExtraBold", Font.BOLD, 30));
		lblRegistrarAluno.setBounds(192, 35, 368, 64);
		contentPane.add(lblRegistrarAluno);
		...
		txtName.setFont(new Font("Montserrat", Font.PLAIN, 11));
		...
		txtCpf.setFont(new Font("Montserrat", Font.PLAIN, 11));
		...
		JLabel lblNameDad = new JLabel("Nome do Pai:");
		lblNameDad.setFont(new Font("Montserrat", Font.BOLD, 11));
		lblNameDad.setForeground(new Color(128, 0, 0));
		lblNameDad.setHorizontalAlignment(SwingConstants.RIGHT);
		lblNameDad.setBounds(119, 155, 128, 14);
		contentPane.add(lblNameDad);
		
		txtNameDad = new JTextField();
		txtNameDad.setFont(new Font("Montserrat", Font.PLAIN, 11));
		...
		txtNameMom.setFont(new Font("Montserrat", Font.PLAIN, 11));
		...
		txtMatricula.setFont(new Font("Montserrat", Font.PLAIN, 11));
		...
		txtSenha.setFont(new Font("Montserrat", Font.PLAIN, 11));
		...
		txtCidade.setFont(new Font("Montserrat", Font.PLAIN, 11));
		...
		txtEstado.setFont(new Font("Montserrat", Font.PLAIN, 11));
	...
	public boolean salvar() throws Exception {
		...
		String caminhoMateriaTemp = "C:\\Users\\mmaci\\Documents\\Estudo\\Curso de Java Se e Banco de Dados\\Aulas\\Sistema_Faculdade\\src\\bancoDados\\bancoMateriatemp.txt";
		String caminhoProfessor =  "C:\\Users\\mmaci\\Documents\\Estudo\\Curso de Java Se e Banco de Dados\\Aulas\\Sistema_Faculdade\\src\\bancoDados\\bancoProfessor.txt";
			...
			if(testarCaminho(caminhoAluno , caminhoAlunoTemp)) {
				...
				if(formularioTest(nomeTemp, cpfTemp,nomePaiTemp,nomeMaeTemp,matriculaTemp,senhaTemp,cidadeTemp,estadoTemp)) {
					BufferedWriter bw = new BufferedWriter(new FileWriter(caminhoAluno,true));
					...
					br.close();
					bw.close();
					if(testarCaminho(caminhoMateria, caminhoMateriaTemp)) {
						BufferedWriter bw2 = new BufferedWriter(new FileWriter(caminhoMateria, true));
						BufferedReader br2 = new BufferedReader(new FileReader(caminhoProfessor));
						while(br2.ready()) {
							String linhaProfessor = br2.readLine();
							String materiaProfessor = linhaProfessor.substring(linhaProfessor.indexOf("#")+1, linhaProfessor.indexOf("$"));
							String matriculaProfessor = linhaProfessor.substring(linhaProfessor.indexOf("@")+1, linhaProfessor.indexOf("#"));
							bw2.write(matriculaProfessor + "!" + materiaProfessor + "@"+ matriculaTemp + "#"+"null"+"$"+"null"+"%"+"null");
						}
						bw2.close();
						br2.close();
						return true;
